    ...
    static {
        ...
        if (javaVersion >= 65544) {
            ...
            try {
                ...
                Throwable initCause2 = new ClassCastException("Instance classloader: " + classLoader2 + ", base type classloader: " + PlatformImplementations.class.getClassLoader()).initCause(e2);
            ...
            try {
                ...
                try {
                    try {
                        ...
                        Throwable initCause3 = new ClassCastException("Instance classloader: " + classLoader3 + ", base type classloader: " + PlatformImplementations.class.getClassLoader()).initCause(e3);
                ...
                try {
                    ...
                    Throwable initCause4 = new ClassCastException("Instance classloader: " + classLoader4 + ", base type classloader: " + PlatformImplementations.class.getClassLoader()).initCause(e4);
