        ...
        while (i < length) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m608contentEqualskV0jMPg(((UByteArray) t).m150unboximpl(), ((UByteArray) t2).m150unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m605contentEqualsFGO6Aew(((UShortArray) t).m410unboximpl(), ((UShortArray) t2).m410unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m606contentEqualsKJPZfPQ(((UIntArray) t).m228unboximpl(), ((UIntArray) t2).m228unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m610contentEqualslec5QzE(((ULongArray) t).m306unboximpl(), ((ULongArray) t2).m306unboximpl())) {
                        return false;
                    }
        ...
        while (i < length) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    sb.append(UArraysKt.m622contentToString2csIQuQ(uByteArray != null ? uByteArray.m150unboximpl() : null));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    sb.append(UArraysKt.m626contentToStringd6D3K8(uShortArray != null ? uShortArray.m410unboximpl() : null));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    sb.append(UArraysKt.m625contentToStringXUkPCBk(uIntArray != null ? uIntArray.m228unboximpl() : null));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    sb.append(UArraysKt.m628contentToStringuLth9ew(uLongArray != null ? uLongArray.m306unboximpl() : null));
                } else {
