...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1345getAdjustmentUwyO8pc() {
    ...
    public long mo1343elapsedNowUwyO8pc() {
        return Duration.m1385minusLRDsOJo(this.mark.mo1343elapsedNowUwyO8pc(), m1345getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1344plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1386plusLRDsOJo(m1345getAdjustmentUwyO8pc(), j), null);
    }
}
