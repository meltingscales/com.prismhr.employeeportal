...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1507catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1512catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1508debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1510debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m1509sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1511sample8GFy2Ro(flow, d);
    }
