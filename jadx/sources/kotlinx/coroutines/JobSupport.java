...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.isActive()) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state$kotlinx_coroutines_core, jobNode)) {
                        return jobNode;
                    }
                } else {
    ...
    public /* synthetic */ boolean cancel(Throwable th) {
        ...
        cancelInternal((th == null || (cancellationException$default = toCancellationException$default(this, th, null, 1, null)) == null) ? new JobCancellationException(cancellationExceptionMessage(), null, this) : cancellationException$default);
        return true;
    }
