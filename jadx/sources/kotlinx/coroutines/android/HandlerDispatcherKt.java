...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m66constructorimpl = Result.m66constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), "Main"));
        } catch (Throwable th) {
        ...
        Main = (HandlerDispatcher) m66constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1523dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$special$$inlined$Runnable$1
