...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1524scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    public long processNextEvent() {
        ...
        L24:
            ...
            monitor-enter(r5)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.firstImpl()     // Catch: java.lang.Throwable -> L4f
            r7 = 0
            if (r6 == 0) goto L49
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r6 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r6     // Catch: java.lang.Throwable -> L4f
            boolean r8 = r6.timeToExecute(r3)     // Catch: java.lang.Throwable -> L4f
            r9 = 0
            if (r8 == 0) goto L3f
            java.lang.Runnable r6 = (java.lang.Runnable) r6     // Catch: java.lang.Throwable -> L4f
            boolean r6 = r10.enqueueImpl(r6)     // Catch: java.lang.Throwable -> L4f
            goto L40
        L3f:
            r6 = r9
        L40:
            if (r6 == 0) goto L47
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.removeAtImpl(r9)     // Catch: java.lang.Throwable -> L4f
            r7 = r6
        L47:
            monitor-exit(r5)
            goto L4a
    ...
    public final void mo1523dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
